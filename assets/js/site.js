...
window.SITE_CONFIG = {
  ...
  slider: {
    ...
    interval_ms: 5000,
    slides: [
      { id: 's1', enabled: true, icon: '🚗', iconName: 'car',      title: 'Rental Cars',           subtitle: 'Premium & budget cars for travel and events',        background_url: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1900&q=80&auto=format&fit=crop', link: 'car-rental-kukas.html',       order: 1 },
      { id: 's2', enabled: true, icon: '🏠', iconName: 'home',     title: 'Rooms & Flats',         subtitle: 'Quick rentals — rooms, flats, PG, properties',       background_url: 'https://images.unsplash.com/photo-1501183638710-841dd1904471?w=1900&q=80&auto=format&fit=crop', link: 'rooms-flats-kukas.html',       order: 2 },
      { id: 's3', enabled: true, icon: '🧱', iconName: 'bricks',   title: 'Construction Labor',    subtitle: 'Mistri, mazdoor, thekedar — all just one call away', background_url: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=1900&q=80&auto=format&fit=crop', link: 'construction-labor-kukas.html', order: 3 },
      { id: 's4', enabled: true, icon: '📚', iconName: 'book',     title: 'Home Tutors',           subtitle: 'Qualified tutors for every class & subject',         background_url: 'https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=1900&q=80&auto=format&fit=crop', link: 'home-tutor-kukas.html',        order: 4 },
